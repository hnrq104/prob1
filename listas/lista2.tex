...
\begin{enumerate}[label=(\alph*)]
	\item
		\begin{proof}
			...
			\]
			Se para algum $i,n$ valer que $\mu(\{i/2^n\}) > 0$, segue pela hipótese que $\mu(\{i/2^n\}) = 1$ e o resultado segue. Se não,
	...
	\item
		\begin{proof}
			...
			que $(X,Y)$ são independentes na álgebra dos retângulos, usando Dynkin segue o resultado.
		\end{proof}
